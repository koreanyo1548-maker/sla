...
/* =====================================================================
   ...
   [2026-09-18 갱신] 데이터 초기화 버튼(#reset-data-btn)은 이제 출시
   진입점에도 노출하기로 해서 index.html 마크업으로 옮겼다 — 여기서 더 이상
   만들지 않는다. dev.js에는 개발 진입점에서만 켜는 기능(분석 콘솔 출력 등,
   window.SLAGMA_DEV 플래그로 platform.js가 처리)만 남는다.
