...
const DEFAULT_CONFIG = {
  ...
  enemy: {
    // 스테이지 1~3은 방어력 0이다. 4스테이지부터 기본값 10에 캐릭터와 같은 복합 성장 비율을 적용한다.
    ...
    // [2026-09-18] 당시 초반 보정을 위해 기본 HP를 1100 → 1500으로 올렸고, 이 기본값은
    // [2026-09-23] 캐릭터 복합 성장식을 공유하도록 바꾼 뒤에도 시작 기준으로 유지한다.
    // [2026-09-23] 확정(인철): 적 기본값은 기존 수치로 되돌리고 성장 결과에 난도 보정 1.15만 곱한다.
    base: { hp: 1500, atk: 70, atkSpeed: 1, travelTimeSec: 10 },
    growthDifficultyMul:1.15,
    defenseGrowth:{freeStages:3,base:10},
