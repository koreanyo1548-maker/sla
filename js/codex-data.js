/* ===== codex-data.js =====
   ...
   [2026-09-22 완만한 지수형] 비용과 정확히 같은 6/10/14/22/48%는 첫 보상이 0.x%로 보여
   성장 체감이 약했다. 총량은 유지하고 10/14/18/24/34%로 완화해 모든 단계가 보상으로 읽히면서
   뒤 단계가 더 큰 구조는 유지한다. 관계 도감의 15/30/55%는 그대로다.
...
// 단계별 보상 비중. 초반 체감과 후반 성장 가치를 함께 살린 완만한 지수형이다.
const CODEX_LEVEL_SHARES=[0.10,0.14,0.18,0.24,0.34];
